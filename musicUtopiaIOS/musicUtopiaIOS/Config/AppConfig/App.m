...
BOOL       const IS_IMG_NAV                         = NO;
NSString * const IMG_NAV_NAME                       = @"";
BOOL       const IS_NAV_BACK_TITLE                  = NO;
NSInteger  const STATUS_COLOR                       = 1;
BOOL       const IS_SHOW_NETWORK_ACTIVITY_INDICATOR = YES;
NSInteger  const NETWORK_TIMEOUT                    = 20;
NSInteger  const DEFAULT_TAB_INDEX                  = 0;
...
NSString * const LOCALSTORE_MODEL_CREATE_TABLES     = @"MemberInfoModel|GroupInfoModel";
...
NSString * const VIDEO_DEFAULT                      = @"video_default";
NSString * const MOBILE_VIDEO_DEFAULT               = @"small_video_default";
NSString * const HEADER_DEFAULT                     = @"header_default";
NSString * const ICON_DEFAULT                       = @"icon_default";
NSString * const AUDIO_DEFAULT                      = @"audio_default";
