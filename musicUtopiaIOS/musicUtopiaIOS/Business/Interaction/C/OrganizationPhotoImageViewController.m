//
//  OrganizationPhotoImageViewController.m
//  musicUtopiaIOS
//
...
@interface OrganizationPhotoImageViewController ()<UIScrollViewDelegate,UIGestureRecognizerDelegate>
{
...
@implementation OrganizationPhotoImageViewController
...
-(void)createImageViewScrollView {
    ...
    for(int i=0;i<self.imageArr.count;i++){
        ...
        NSString * imageURL = [NSString stringWithFormat:@"%@%@",IMAGE_SERVER,dictData[@"op_img_url"]];
        NSLog(@"%@",imageURL);
