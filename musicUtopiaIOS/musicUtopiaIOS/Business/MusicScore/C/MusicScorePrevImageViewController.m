//
//  MusicScorePrevImageViewController.m
//  musicUtopiaIOS
//
...
@interface MusicScorePrevImageViewController ()<UIScrollViewDelegate,UIGestureRecognizerDelegate>
{
...
@implementation MusicScorePrevImageViewController
...
-(void)createImageViewScrollView {
    ...
    for(int i=0;i<self.imageArr.count;i++){
        ...
        //NSLog(@"%@",imageURL);
        PhotoView *photoView = [[PhotoView alloc] initWithFrame:CGRectMake(0,0,imageViewScrollView.frame.size.width,imageViewScrollView.frame.size.height) andImage:self.imageArr[i] dataType:URL_TYPE imgData:nil];
